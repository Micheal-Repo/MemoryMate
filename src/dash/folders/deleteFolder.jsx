...
//components
import {useDeleteFolderMutation} from "./folderApiSlice"
...
const DeleteFolder =({
 ...
 //   }
  ...
  return(
        <>
<div className={`${deleteFolderOpen ? "scale-100" : "scale-0"} absolute top-0 left-0 w-full h-full bg-black opacity-[0.7] z-30`}>
</div>
