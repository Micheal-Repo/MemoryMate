...
//  const StyleH = useStyleH("10rem")
  ...
  return(
    <div style={useStyleH("5rem")} className="  notesList w-full overflow-auto">
    ...
    <div style={useStyleH("5rem")} className="scroll p-3 w-full overflow-y-scroll  flex gap-3 flex-col">
      <Note  type={"table"}/>
      <Note type={"list"}/>
      <Note type={"card"}/>
      <Note/>
